...
//                el.parentNode.insertBefore(butl, el);
                if (Math.ceil(childs.length / colcount) > 1) {
                    el.insertBefore(butr, el.getElementsByClassName('view-container')[0]);
                    el.insertBefore(butl, el.getElementsByClassName('view-container')[0]);
                }
