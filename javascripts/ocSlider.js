    ...
    Ocslider.prototype = {
        ...
        putSideButton: function (el, colcount, i) {
            ...
            if (Math.ceil(childs.length / colcount) > 1) {
                // little modification
                var elElement = el.getElementsByClassName('view-container')[0];
                elElement.insertBefore(butr, el.getElementsByClassName('view-content')[0]);
                elElement.insertBefore(butl, el.getElementsByClassName('view-content')[0]);
